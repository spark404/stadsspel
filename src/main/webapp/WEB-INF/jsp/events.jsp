...
<html lang="nl">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="/events"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Berichten</a></li>
    ...
    <div class="container">
      <h2><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Berichten voor ${group.groupname}</h2>
